...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 20 Des 2021 pada 08.59
...
CREATE TABLE `buku` (
  ...
  `image` varchar(256) CHARACTER SET latin1 DEFAULT 'book-defult-cover.jpg'
...
(2, 'Mudah Belajar Komputer Anak', 1, 'Bambang Agus Setiawan', 'Huta Media', 2014, '9786025118500', 5, 3, 1, 'img1557402397.jpg'),
...
(5, 'Bahasa Indonesia', 2, 'Umri Nur\'aini dan Indriyani', 'Pusat Perbukuan', 2015, '727554724884', 3, 0, 0, 'img1557402703.jpg'),
...
(12, 'admin', 'admin@admin.com', 'default.jpg', '$2y$10$/Ia3BZtMk/kCBDieIMQ3iOBWMxNWNuSXaoh3TsZ5rTHkqlGyL0foG', 1, 1, 1639985832);
